    ...
    public static void ConfigureSerilog(this IHostBuilder host, IConfiguration configuration, IHostEnvironment environment)
    {
        ...
        host.UseSerilog((context, services, loggerConfiguration) =>
        {
            loggerConfiguration
                ...
                .MinimumLevel.Override("NHibernate", environment.IsDevelopment() ? LogEventLevel.Debug : LogEventLevel.Warning)
                .MinimumLevel.Override("NHibernate.SQL", environment.IsDevelopment() ? LogEventLevel.Debug : LogEventLevel.Warning)
